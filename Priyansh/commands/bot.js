...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  var rand = tl[Math.floor(Math.random() * tl.length)]
    ...
    if ((event.body.toLowerCase() == "Sasta bot") || (event.body.toLowerCase() == "sasta bot") || (event.body.toLowerCase() == "Bakwas bot") || (event.body.toLowerCase() == "bakwas bot")) {
     return api.sendMessage("──── •💜• ────𒁍≛⃝●☆●🥀💔🪽𝐀𝐮𝐐𝐚𝐚𝐓 𝐒𝐞 𝐁𝐚𝐇𝐚𝐫 𝐂𝐡𝐞𝐞𝐙 𝐊𝐨 𝐔𝐬𝐞 𝐍𝐚𝐡𝐈 𝐊𝐚𝐫𝐓𝐞 𝐂𝐡𝐨𝐌𝐮 𝐍𝐢𝐊𝐚𝐋 𝐏𝐞𝐇𝐥𝐢 𝐅𝐮𝐑𝐬𝐚𝐓 𝐌𝐞 🤣🤣😾──── •🩷• ────𒁑≛⃝●☆●🥀💔❀", threadID);
   };

   if ((event.body.toLowerCase() == "🤮🤮") || (event.body.toLowerCase() == "🤮")) {
     return api.sendMessage("──── •💜• ────𒁍≛⃝●☆●🥀💔🪽 𝐊𝐨𝐧𝐬𝐚 𝐌𝐚𝐇𝐢𝐧𝐚 𝐂𝐡𝐚𝐋 𝐑𝐚𝐡𝐀 𝐇𝐞 𝐁𝐚𝐛𝐘 𝐊𝐚𝐇𝐨 𝐓𝐨 𝐃𝐨𝐂𝐭𝐨𝐑 𝐁𝐮𝐋𝐚𝐚𝐥𝐔 😝──── •🩷• ────𒁑≛⃝●☆●🥀💔❀", threadID);
   };

    if ((event.body.toLowerCase() == "🤗🤗") || (event.body.toLowerCase() == "🤗")) {
     return api.sendMessage("──── •💜• ────𒁍≛⃝●☆●🥀💔🪽𝐀𝐚𝐎 𝐌𝐞𝐫𝐈 𝐉𝐚𝐚𝐍 𝐆𝐚𝐋𝐞 𝐋𝐚𝐆 𝐉𝐚𝐎 𝐓𝐡𝐨𝐃𝐚 𝐒𝐮𝐤𝐎𝐨𝐍 𝐀𝐚 𝐉𝐚𝐘𝐞 ☺️──── •🩷• ────𒁑≛⃝●☆●🥀💔❀", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bc") || (event.body.toLowerCase() == "bc")) {
     return api.sendMessage("──── •💜• ────𒁍≛⃝●☆●🥀💔🪽𝐁𝐜 𝐁𝐎𝐥𝐍𝐞 𝐒𝐞 𝐏𝐞𝐇𝐥𝐄 𝐊𝐡𝐔𝐝 𝐊𝐚 𝐌𝐨𝐨𝐇 𝐀𝐚𝐲𝐈𝐍𝐞 𝐌𝐄 𝐃𝐞𝐤𝐡 𝐁𝐊𝐋 🤣🤣──── •🩷• ────𒁑≛⃝●☆●🥀💔❀ ", threadID);
   };
...
if ([
 ...
 if ([
  ...
  if ((event.body.toLowerCase() == "🤔🤔") || (event.body.toLowerCase() == "🤨🤨")) {
     return api.sendMessage("️i͠†ƞʌ ƙɪ̽ɣʌ 𝗌❍c̬̽ɧ ɽʌɧɘ ɱɘɽııʝɑ̽ɑ̽ŋ͢ 🤨", threadID);
   };
